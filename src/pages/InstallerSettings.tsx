        ...
        <div className="px-6 py-6 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">CRM-Integration & Webhook</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-8 max-w-4xl mx-auto space-y-8">
          ...
          <section className="bg-[#141414] rounded-2xl border border-white/5 overflow-hidden">
            ...
            <div className="px-6 py-6 space-y-6">
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-semibold text-gray-300" htmlFor="webhook-url">
                  Webhook-URL
                </label>
                <input
                  id="webhook-url"
              ...
              {/* Webhook Secret */}
              <div className="space-y-1.5">
                <label className="text-sm font-semibold text-gray-300" htmlFor="webhook-secret">
                  Webhook-Secret <span className="text-gray-500 font-normal">(optional)</span>
                </label>
                ...
                <p className="text-xs text-gray-500">
                  ...
                  <code className="bg-[#0F0F0F] px-1 rounded text-gray-400">X-Voltify-Signature: sha256=…</code>
                </p>
              </div>
          ...
          <div className="flex items-start gap-3 bg-amber-500/5 border border-amber-500/20 rounded-xl px-5 py-4">
            ...
            <div className="text-sm text-amber-400/80">
              ...
              automatisch <strong className="text-amber-400">3× wiederholt</strong> (nach 1 s, 2 s, 4 s Backoff).
